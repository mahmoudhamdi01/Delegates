...
namespace Delegates.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260721212139_Execute Phase_06")]
    partial class ExecutePhase_06
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delegates.Infrastructure.Entities.MasterData.Visit", b =>
                {
                    ...
                    b.Property<int>("VisitDestinationId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Delegates.Infrastructure.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<string>("DeliveryPostponeReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("PaymentReceivedMethod")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Delegates.Infrastructure.Entities.MasterData.Visit", b =>
                {
                    ...
                    b.HasOne("Delegates.Infrastructure.Entities.MasterData.VisitDestination", "VisitDestination")
                        .WithMany()
                        .HasForeignKey("VisitDestinationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Delegate");

                    b.Navigation("VisitDestination");
                });
            ...
            modelBuilder.Entity("Delegates.Infrastructure.Entities.UserManagement.DeviceToken", b =>
                {
                    b.HasOne("Delegates.Infrastructure.Entities.UserManagement.ApplicationUser", "User")
                        .WithMany()
